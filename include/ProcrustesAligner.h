...
#ifndef KINECT_FUSION_PROCRUSTESALIGNER_H
#define KINECT_FUSION_PROCRUSTESALIGNER_H

#endif //KINECT_FUSION_PROCRUSTESALIGNER_H
...
private:
    static Vector3f computeMean(const std::vector<Vector3f>& points) {
    ...
    static Vector3f computeTranslation(const Vector3f& sourceMean, const Vector3f& targetMean) {
